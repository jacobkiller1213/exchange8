              ...
              (0, c.jsxs)(l.D, {
                ...
                children: [
                      ...
                      children: (0, c.jsxs)("div", {
                        ...
                        children: [
                          ...
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                              "При работе с цифровыми финансовыми активами могут существовать иные риски, не предусмотренные настоящим Пользовательским соглашением и Администрацией сайта CryptoCoinHub.",
                          }),
                        ],
                      }),
                    },
                      ...
                      children: (0, c.jsxs)("div", {
                        ...
                        children: [
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                              "2.1. CryptoCoinHub — это торговая марка системы, предоставляющей Пользователям возможность обмена цифровой и электронной валюты.",
                          }),
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                          ...
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                              "2.3. Пользователь — это любое физическое/юридическое лицо, использующее услуги сервиса CryptoCoinHub.",
                          }),
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                  ...
                  (0, c.jsx)(
                    r.R,
                    {
                      "aria-label": "Правила пользования сайтом CryptoCoinHub",
                      title: "Правила пользования сайтом CryptoCoinHub",
                      children: (0, c.jsxs)("div", {
                        className: "space-y-4",
                        children: [
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                              "3.1. Пользователь обязуется использовать сайт CryptoCoinHub исключительно в законных целях и в соответствии с настоящим Соглашением.",
                          }),
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                              "3.2. Сайт CryptoCoinHub предназначен для использования исключительно в личных целях. Пользуясь услугами данного сервиса, Вы даете свое согласие на передачу CryptoCoinHub достоверных данных о себе. Вы так же даете согласие на обработку личных данных.",
                          }),
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                  ...
                  (0, c.jsx)(
                    r.R,
                    {
                      "aria-label": "Услуги, предоставляемые сайтом CryptoCoinHub",
                      title: "Услуги, предоставляемые сайтом CryptoCoinHub",
                      children: (0, c.jsxs)("div", {
                        className: "space-y-4",
                        children: [
                          (0, c.jsx)("p", {
                          ...
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                              "4.9. Все услуги сервиса CryptoCoinHub предоставляются без каких-либо явных или подразумеваемых гарантий, в частности, без подразумеваемых гарантий товарной пригодности и пригодности для определенной цели. Компания не гарантирует, что услуги CryptoCoinHub, а также сайт CryptoCoinHub будут доступны в 100% случаев для удовлетворения Ваших потребностей. Компания будет стремиться предоставить вам свои услуги как можно скорее, но нет никаких гарантий, что доступ не будет прерван или что не будет никаких задержек, сбоев, ошибок, упущений или потери передаваемой информации.",
                          }),
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                              "4.10. CryptoCoinHub будет прилагать разумные усилия для обеспечения доступа к услугам и сайту CryptoCoinHub в соответствии с настоящим Соглашением. Тем не менее, CryptoCoinHub может приостановить использование сайта для технического обслуживания и приложит разумные усилия, чтобы предварительно уведомить Вас об этом. Таким образом, Вы соглашаетесь с тем, что принимаете на себя риски, связанные с тем фактом, что вы не всегда можете пользоваться услугами и сайтом CryptoCoinHub или выполнять срочные транзакции.",
                          }),
                        ],
                      }),
                    },
                      ...
                      children: (0, c.jsxs)("div", {
                        ...
                        children: [
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                              "7.1. Сервис CryptoCoinHub предоставляет услуги по обмену, покупке и продаже электронных активов. Сервис CryptoCoinHub не предоставляет услуги по сбору средств, не предоставляет услуг по оплате товаров.",
                          }),
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                              "7.2. Сервис CryptoCoinHub не несет ответственности перед Пользователем за финансовые потери, вызванные незаконными действиями третьих сторон, которые невозможно предсказать или предотвратить.",
                          }),
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                              "7.3. Сервис CryptoCoinHub не несет ответственности за любые отложенные или нереализованные Заявки, вызванные ошибкой другой Платежной системы или банка, указанными пользователем в оформленной Заявке. Пользователь соглашается с тем, что в таком случае все претензии будут направлены в платежную систему или банк. Сервис CryptoCoinHub окажет необходимую помощь для подачи жалобы или требования другому партнеру или банку.",
                          }),
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                              "7.4. Сумма в заявке пользователя и сумма отправленная пользователем по данной заявке должны полностью совпадать. В случае неучета комиссии, или же в другом случае несовпадения суммы, пользователь обязуется совершить повторный платеж правильной суммы с учетом данной комиссии. После успешного проведения повторной транзакции сервис обязуется совершить возврат обеих транзакций совершенных пользователем. В случае несоблюдения данного правила, средства пользователя будут заморожены. По истечению 48 часов средства обозначаться как утерянная криптовалюта и будут списаны со счета сервиса CryptoCoinHub соответствующими органами регуляторов в лице Комитета Государственной Думы по финансовому рынку.",
                          }),
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                          ...
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                              "7.6. Сервис CryptoCoinHub не несёт ответственности за частичное или полное несоблюдение данных Условий использования, если таковое явилось следствием обстоятельств непреодолимой силы, которые невозможно предотвратить разумными мерами.",
                          }),
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                      ...
                      children: (0, c.jsxs)("div", {
                        ...
                        children: [
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                              "7.10. Пользователь несет ответственность за достоверность и полноту информации и данных, которые он предоставил во время создания заявки. В случае, если Пользователь ввел неправильные личные данные или предоставил неверные данные для исполнения Заявки, Сервис CryptoCoinHub не несёт ответственности за любые убытки Пользователя, возникшие в результате такой ошибки.",
                          }),
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                      ...
                      children: (0, c.jsxs)("div", {
                        ...
                        children: [
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                              "9.1. Использование Сервиса CryptoCoinHub в целях осуществления мошеннических и незаконных операций запрещено.",
                          }),
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                              "9.2. Операторы сервиса CryptoCoinHub юридически обязаны предоставлять информацию о платежах, Пользователях и Операциях любым государственным органам, имеющим законное право запрашивать соответствующую информацию.",
                          }),
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                          ...
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                              "9.4. Способ обработки и защиты личной информации подробно описан в Политике конфиденциальности, опубликованной на веб-сайте Сервиса CryptoCoinHub, требуемой для заключения договорных отношений между Пользователем и Сервисом CryptoCoinHub.",
                          }),
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                              "9.5. Сервис CryptoCoinHub, в случае подозрительных действий в процессе оформления заявки Пользователем, во избежание ущерба от хакерских атак, вправе приостанавливать выполнение таких операций до выяснения причин этих действий.",
                          }),
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                              "9.6. Сервис CryptoCoinHub вправе отказать в выполнении операции обмена, покупки и продажи электронных/цифровых валют, если передача электронного актива на счет Сервиса была произведена без оформления Заявки при помощи пользовательских интерфейсов на Сайте Сервиса.",
                          }),
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                          ...
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                              "9.9. Срок ответа службы поддержки Сервиса CryptoCoinHub может составлять до 24 часов с момента получения соответствующего запроса Пользователя.",
                          }),
                        ],
                      }),
                    },
                      ...
                      children: (0, c.jsxs)("div", {
                        ...
                        children: [
                          ...
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                              "11.2. Сервис CryptoCoinHub вправе в одностороннем порядке вносить изменения в Соглашение путем публикации изменений на Сайте Сервиса. Изменения вступают в силу с момента опубликования, если иной срок вступления изменений в силу не определен дополнительно при их публикации. Пользователь имеет право расторгнуть договорные отношения с Сервисом CryptoCoinHub из-за его несогласия с изменением таких Условий. Пользователь должен уведомить Сервис CryptoCoinHub о своем несогласии с изменением Условий и прекращению договорных отношений.",
                          }),
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                              "11.3. Сервис CryptoCoinHub вправе отправлять Пользователю на указанный им e-mail информацию рекламного характера.",
                          }),
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                              "11.4. Информация, размещенная на сайте, включая все графические изображения, текстовую информацию, коды программ и т.д., является собственностью CryptoCoinHub и защищена законами об авторском праве.",
                          }),
                          (0, c.jsx)("p", {
                            className: "docs-p",
                            children:
                  ...
                  (0, c.jsx)(
                    r.R,
                    {
                      ...
                      children: (0, c.jsx)("div", {
                        ...
                        children: (0, c.jsx)("p", {
                          children:
                            "12.1. Вы можете обратиться в службу поддержки в рабочее время посредством доступного мессенджера, указанного на сайте CryptoCoinHub.",
                        }),
                      }),
                    },
                    "18"
